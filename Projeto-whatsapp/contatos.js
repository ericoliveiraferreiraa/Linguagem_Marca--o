      ...
      contacts: [
        {
          ...
          messages: [
            {
              sender: "me",
              content: "Olá Ana, como você está hoje?",
              time: "14:20",
            },
            {
              sender: "Ana Maria",
            ...
            {
              sender: "me",
              content: "Que bom ouvir isso. Você tem algum plano para o fim de semana?",
              time: "14:30",
            },
            {
              sender: "Ana Maria",
              content: "Ainda não. Estou pensando em ir à praia. E você?",
              time: "14:35",
            },
          ],
        },
        {
          ...
          messages: [
            {
              sender: "me",
              content: "Oi Jane, como vão as coisas?",
              time: "09:00",
            },
            {
              sender: "Jane Smith",
              content: "Estou bem, obrigada. E você?",
              time: "09:05",
            },
            {
              sender: "me",
              content: "Estou indo bem. A propósito, você viu os últimos designs para o novo projeto?",
              time: "09:10",
            },
            {
              sender: "Jane Smith",
              content: "Sim, eu vi. Ficaram ótimos!",
              time: "09:15",
            },
          ],
        },
        {
          ...
          messages: [
            {
              sender: "me",
              content: "Oi Mark, como estão as coisas?",
              time: "13:00",
            },
            {
              sender: "Mark Johnson",
              content: "Tudo indo bem. E com você?",
              time: "13:05",
            },
            {
              sender: "me",
              content: "Estou bem. A propósito, você tem alguma atualização sobre o desenvolvimento da API?",
              time: "13:10",
            },
            {
              sender: "Mark Johnson",
              content: "Sim, estamos fazendo um bom progresso. Devemos conseguir entregar dentro do prazo.",
              time: "13:15",
            },
          ],
        },
      ...
      contacts: [
        {
          ...
          messages: [
            {
              sender: "me",
              content: "Olá papai, como você está hoje?",
              time: "14:20",
            },
            {
        ...
        },
        {
          ...
          number: "26999999911",
          description: "Free",
          image: "26999999110.png",
          gender: "male",
          messages: [
            {
              sender: "me",
              content: "Oi John, como vão as coisas?",
              time: "09:00",
            },
            {
...
export function listarContatosUsuario(idUsuario) {
  console.table(usuarios["whats-users"][idUsuario].contacts);
}

export function listarMensagensUsuario(idUsuario, idContato) {
  console.table(usuarios["whats-users"][idUsuario].contacts[idContato].messages);
}

  // Crie uma função que liste todos os usuários do console.table

  // Crie uma função que receba o índice do usuário e retorne no console table todos os contatos delete

  // Crie uma função que receba o índice do usuário e do contato e liste todas as mensagens trocas com este contato